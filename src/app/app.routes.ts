...
import { UserDashboardDetailUserComponent } from './pages/dashboard/user-dashboard-detail-user/user-dashboard-detail-user';
...
export const routes: Routes = [
  ...
  { path: 'dashboard/user/userdetail', component: UserDashboardDetailUserComponent },
